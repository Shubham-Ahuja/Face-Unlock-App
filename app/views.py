...
def predict(request):
    ...
    email_file=open(r'C:\\Users\shubham\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\\email.txt','a')
    email_file.writelines(str(email))
    email_file.writelines("\n")
    email_file.close()
    name_file=open(r"C:\\Users\\shubham\\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\\name.txt",'a')
    ...
    # p=p.strip()
    # print(p)
    file_read = open(r"C:\\Users\\shubham\\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\user.txt",'r')
    user_id=int(file_read.read())
    vid  = cv2.VideoCapture(0)
    dataset = cv2.CascadeClassifier(r"C:\\Users\\shubham\\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\\data.xml")
    i = 0
    face_list = []
    while True:
        ret, frame = vid.read()
        if ret:
            ...
            cv2.imwrite(f"C:\\Users\\shubham\\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\\pics\\user_{user_id}.png", face)
    ...
    np.save(f"C:\\Users\\shubham\\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\\faces\\user_{user_id}.npy", np.array(face_list))
    vid.release()
    cv2.destroyAllWindows()
    user_id=user_id+1
    file_write = open(r"C:\\Users\shubham\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\\user.txt",'w')
    file_write.write(str(user_id))   
...
def recognize(request):
    ...
    email_file= open(r"C:\\Users\\shubham\\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\\email.txt", 'r')
    name_file= open("C:\\Users\\shubham\\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\\name.txt", 'r')
    user_count=1
    while email_file:
    ...
    with open(r"C:\\Users\\shubham\\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\\email.txt", 'r') as fp:
    ...
    facesPath = r"C:\\Users\\shubham\\Downloads\\face_app_final\\face_recognition_app\\FaceApp\\app\\static\\faces"
    # print(facesPath)
